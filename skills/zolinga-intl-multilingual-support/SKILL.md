...
- If you are asked to translate .po files, do not use any external tools or programs unless specifically instructed. Edit the .po files directly and translate the `msgstr` values while leaving the `msgid` values unchanged. 
