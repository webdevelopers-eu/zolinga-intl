...
You may use context separator `"\x04"` to separate the context from the message. This is useful when you have multiple translations for the same string in different contexts.

Example:

```php
echo dgettext('my-module', "Welcome message\x04Hello, world!");
```
